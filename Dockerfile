...
ENV PROJECT_NAME probation-task-sources
ENV GIT_USR "$GIT_USR"
ENV GIT_PWD "$GIT_PWD"
ENV GIT_DOMAIN 10.240.3.20
ENV GIT_PROJECT_PATH self-education/$PROJECT_NAME.git
ENV GIT_REPO=http://$GIT_USR:$GIT_PWD@$GIT_DOMAIN/$GIT_PROJECT_PATH
